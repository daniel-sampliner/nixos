...
# Generated by Powerlevel10k configuration wizard on 2024-04-07 at 10:16 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${name:-$IN_NIX_SHELL}'
  ...
  function prompt_shlvl() {
    p10k segment -c "${SHLVL:#<-2>}" -t "$SHLVL"
  }
  ...
  typeset -g POWERLEVEL9K_SHLVL_FOREGROUND=7
  typeset -g POWERLEVEL9K_SHLVL_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  # Handle Terminal Resize/Reflow
  # https://github.com/romkatv/powerlevel10k?tab=readme-ov-file#mitigation
...
typeset -g POWERLEVEL9K_CONFIG_FILE=${XDG_RUNTIME_DIR:?}/p10k.zsh
